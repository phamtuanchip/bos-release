<template>
  <el-form :model="model" ref="FieldInfoDialog" :rules="formRule" label-width="180px" label-position="left">
    ...
    <el-row v-show="isSystemAdmin">
      <el-col :span="24">
        <el-form-item label="Các thuộc tính:">
          ...
          <el-checkbox v-model="model.TotalRow">Tính tổng</el-checkbox>
          <el-checkbox v-model="model.ProgressBar">Thanh %</el-checkbox>
        </el-form-item>
      </el-col>
      <el-col :span="24">
    ...
    <el-row v-show="isSystemAdmin">
      <el-col :span="12" class="p-2">
        <el-form-item label="Trường điều kiện ngày">
          <el-input v-model="model.ListDateTime"/>
        </el-form-item>
      </el-col>
      <el-col :span="12" class="p-2">
        <el-form-item label="Trường lấy ngày">
          <el-input v-model="model.ListGetDate"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row v-show="isSystemAdmin">
      <el-col :span="24" class="p-2">
        <el-form-item label="Mã điều kiện">
          <el-input v-model="model.ListDateCode"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row v-show="isSystemAdmin">
      <el-col :span="24" class="p-2">
        <el-form-item label="Màu theo điều kiện:">
          <el-input type='textarea' v-model="model.ColorCase" :rows="4"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row v-show="isSystemAdmin">
