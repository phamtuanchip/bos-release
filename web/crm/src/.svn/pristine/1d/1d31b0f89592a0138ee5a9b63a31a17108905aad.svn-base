...
const ImpExpReceipt = () => import('@/components/static/ImpExpWarehouse/ImpExpReceipt')
...
import ProjectView from '@/components/static/ProjectView'
...
import TaskSummaryTable from '@/components/static/TaskSummaryTable'
