  ...
  <div class="form-list">
    <el-form :model="model" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="Cho phép quản trị" v-show="isSystemAdmin">
       ...
       <el-form-item label="Hiện tổng" v-show="isSystemAdmin">
        <el-switch v-model="model.Description.TotalRow"></el-switch>
      </el-form-item>
      ...
      <el-row  v-show="model.Description.DisplayType == 'Tree'">
        <el-col :span="6">
          <el-form-item label="Mã khoá cây" prop="TreeKey">
            <el-input v-model="model.Description.TreeKey" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Mã khoá cha" prop="TreeParent">
            <el-input v-model="model.Description.TreeParent" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Mã khoá con" prop="TreeChild">
            <el-input v-model="model.Description.TreeChild" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
         <el-form-item label="Đóng cây tree">
          <el-switch v-model="model.Description.TreeExpandAll"></el-switch>
        </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="Mã khoá hiển thị" prop="TreeCaptionKey">
            <el-input v-model="model.Description.TreeCaptionKey" ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      bindEditor() {
        ...
        if (this.action === '') {
          this.model = {Description: {Buttons: [], DisplayType: 'Popular', Notifications: [], TreeKey: 'Id', TreeParent: 'ParentId', TreeChild: 'children', TreeExpandAll: false}, ObjectFields: []};
          this.bindComboModel('DisplayType');
          this.bindDataGroupSource();
