      ...
      <el-tab-pane label="Biểu mẫu" name="1">
        <el-form :model="model" :rules="rules" ref="formForm" label-width="120px" class="demo-ruleForm">
          ...
          <div v-if="model.FormElementType">
            <div v-if="['Select','Multi','Radio','MultiTree','Autocomplete'].indexOf(model.FormElementType.Name)>=0">
              ...
              <el-form-item label="Mã">
                <el-input v-model="model.FormCode" :type="'textarea'"/>
              </el-form-item>
              ...
              <el-form-item label="Giá trị hiển thị">
                <el-input v-model="model.FormDisplayText" :type="'textarea'"/>
              </el-form-item>
              ...
              <el-form-item label="Tùy chọn khác">
                <el-input v-model="model.FormOther" :type="'textarea'"/>
              </el-form-item>
          ...
          <el-card v-if="model.FormFieldType && model.FormFieldType.Name === 'General'" v-for="item in viewModel.checkedItems" :key="item.Id">
      ...
      <el-tab-pane label="Bộ lọc" name="2">
        <el-form :model="viewModel" :rules="rules" ref="filterForm" label-width="120px" class="demo-ruleForm">
          ...
          <div v-if="model.FilterElementType">
            <div v-if="['Select','Multi','Radio','MultiTree','Autocomplete'].indexOf(model.FilterElementType.Name)>=0">
              <el-form-item label="Mã Template lấy dữ liệu">
    ...
    methods: {
      ...
      bindEditor() {
        ...
        if (dataToPass.action === 'edit') {
          ...
          if(ctrl.model.History == undefined){
            ctrl.$set(ctrl.model,'History', true);
          }
          if(ctrl.model.FormIncludeSubmit == undefined){
            ctrl.$set(ctrl.model,'FormIncludeSubmit', true);
          }
          if(ctrl.model.FormElementType == undefined){
            ctrl.$set(ctrl.model,'FormElementType', '');
            // ctrl.model.FormElementType = '';
          }
          if(ctrl.model.FilterElementType == undefined){
            ctrl.$set(ctrl.model,'FilterElementType', '');
      ...
      save() {
        ...
        //if(ctrl.model.FormJsonExpression) return;
