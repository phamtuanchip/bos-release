<template>
  <div class="dropdownactivity">
    <b-nav-item-dropdown right no-caret>
      ...
      <div class="content">
          <div :class="'message px-1 mb-1' + item.Active" v-for="item in datasource" v-bind:key="item.Id" @click="openNotificationDetail(item)" v-loading.fullscreen.lock="fullscreenLoading">
