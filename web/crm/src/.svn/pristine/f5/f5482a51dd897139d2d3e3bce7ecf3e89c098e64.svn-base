          ...
          case 'CombineData':
            ...
            switch (calculatorField.FieldColumnType) {
              case 'Condition':
                ...
                if(replacedExpression == '' && this.$Utils.isEmpty(this.Setting.parentSetting.object, object.name)) {
                  object.value = this.Setting.parentSetting.object[object.name]
                }
                break
              case 'String':
                /** trường hợp là string thì loại bỏ các dấu toán học */
              ...
              case 'Integer':
                ...
                if (replacedExpression !== '') {
                  ...
                  object.value = parseInt(this.$Utils.calculator(replacedExpression))
                }
                if (
          ...
          case 'CompareValue':
            ...
            switch (calculatorField.FieldColumnType) {
              case 'Condition':
                ...
                if(newValue == '' && this.$Utils.isEmpty(this.Setting.parentSetting.object, object.name)) {
                  object.value = this.Setting.parentSetting.object[object.name]
                }
                break
              case 'String':
    ...
    submitDefault (objReturn) {
      ...
      if (ctrl.$Utils.isEmpty(ctrl.currentButtonSetting, 'AfterUpdate')) {
        switch (ctrl.currentButtonSetting.AfterUpdate) {
          case 'Redirect':
            console.log(ctrl.currentButtonSetting.Redirect)
