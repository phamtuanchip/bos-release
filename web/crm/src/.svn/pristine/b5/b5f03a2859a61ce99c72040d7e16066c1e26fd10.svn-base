...
export default {
  ...
  data: function () {
    return {
      tableItems: [
        {
          avatar: { url: 'assets/images/avatars/profile.png', status: 'success' },
        ...
        {
          avatar: { url: 'assets/images/avatars/profile.png', status: 'danger' },
        ...
        {
          avatar: { url: 'assets/images/avatars/profile.png', status: 'warning' },
        ...
        {
          avatar: { url: 'assets/images/avatars/profile.png', status: '' },
