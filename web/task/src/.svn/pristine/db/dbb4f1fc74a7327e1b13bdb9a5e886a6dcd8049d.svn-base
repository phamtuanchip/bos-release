        ...
        <el-tabs v-model="TargetTab" @tab-click="changeTab">
          ...
          <el-tab-pane label="Mục tiêu tuần" name="weekTargets">
            <div id="configuration-list-detail" v-if="TargetTab === 'weekTargets' && Display">
               ...
               <TargetTimeLine v-show="isShowTimeLine" :datasrc="listTargetDetail" :fnOpenDetail="openTargetDetail"/>
    ...
    getObject() {
      ...
      if (vm.Type === "Target") {
        ...
        if (vm.$isMantisAdmin() && vm.Target === 0) {
          requestSearch.R1_TargetType = "1;2;3";
            ...
            if (
              ...
              if (!vm.$Utils.isEmpty(ele.Progress)) {
                ...
                ele.percentage  = 0
                 ...
                 ele.percentage  = parseFloat(ele.Progress);
                 if(ele.percentage > 100) ele.percentage = 100;
