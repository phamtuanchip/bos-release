<template xmlns:v-dragscroll="http://www.w3.org/1999/xhtml">
  <div class="scrumBoard">
    <div class="card-header p-0">
      <div class="">
        <div class="row pr-2 pl-2">
          <div class="col m-auto text-nowrap">
            <i class="fa fa-trello"></i><span><b> Bảng</b></span>
            ...
            <router-link v-if="$isMobileDevice" to="/timeline" class=""><i class="fa fa-list-alt"> </i>
              <span> Thời gian</span></router-link>
          </div>
    ...
    <div class="kanban" v-dragscroll:firstchilddrag>
      <kanban-board :stages="stages" :blocks="taskLists" @update-block="updateBlock"
                    :isDragable="$isMobileDevice ? false: true">
          ...
          <div @click="showDetailScrum(block, false)">
            ...
            <div class="row">
              ...
              <div class="col-6 text-right">
                <i class="fa fa-comments" aria-hidden="true" @click.stop="showDetailScrum(block, true)"></i><span> {{block.totalCmt ? block.totalCmt : 0}}</span>
              </div>
            </div>
          </div>
        </div>
...
<script>
  import Vue from "vue";
  import KanbanBoard from "@/lib/Kanban";
    ...
    methods: {
      bindDataSearch() {
        ...
        this.$Utils.post(projectsRequest).then(data => {
          var projects = this.$Utils.getDataWithRoot(data.R1, "Data.UserDS.Group");
      ...
      getTask(data) {
        ...
        request.R1_RequestFields =
          "Id;Name;Index;TotalComment;PlanStartDate;Deadline;Status;Worker;WorkerName;PlanManHour;RemainingManHour;GroupRoot;Manager;Subscribe;GroupPermission";
      ...
      updateBlock(id, status) {
        ...
        $.each(this.taskLists, (k, v) => {
          ...
          if (v.id == id) {
            ...
            var sourceData = this.$Lodash.cloneDeep(v.task);
            var sourceSetting = ctrl.$Lodash.cloneDeep(ctrl.SettingForm);
            ctrl.$Utils.replacePermission(sourceSetting, sourceData)
