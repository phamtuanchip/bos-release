  ...
  <div class="project-report">
          ...
          <div  :class="!$isMobileDevice ?  'col text-right p-0' : 'mobile'">
            <!-- <div class="row text-right pr-0">
              <div div class="col-md-6 col-sm-6 col-5 pr-0"> -->
                <el-form :inline="true" class="text-nowrap"> 
                  <el-form-item v-if="!$isMobileDevice" label="" class="mb-0">
                  ...
                  <el-form-item label="" :class="$isMobileDevice ? 'w-25' : ''"  class="mb-0">
                ...
                <!-- <div div class="col-md-6 col-sm-6 col-5 pl-0"> -->
                  ...
                  <el-form-item  class="mb-0">
                    <i class="filter fa fa-filter fa-lg" v-b-modal.ProjectFilter></i>
                  </el-form-item>
    ...
    <el-tabs v-model="activeName" >
       <el-tab-pane label="Bảng thời gian" name="timeline">
        <ProjectGantt :projects="viewModelGroup" :workers="DataList['Worker']" ></ProjectGantt>
      </el-tab-pane>
      <el-tab-pane label="Thống kê" name="calculation">
        <ProjectCount :projects="viewModelGroup" :workers="DataList['Worker']"></ProjectCount>
      </el-tab-pane>
  ...
  methods: {
    ...
    search() {
      ...
      var dataToPass = {
        ...
        selectedProjs: this.form.VersionProject
          ? this.form.VersionProject
          : this.VersionProject
      };
