    ...
    <div class="comments">
      <div class="comment-wrap" v-if="type !='popup'">
        ...
        <div class="comment-block">
          ...
          <ul class="comment-actions w-100" :class="$isMobileDevice ? 'pl-0' : 'text-right'">
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      ...
                      <img :src="base + 'Download.ashx?Id=' + scope.row.AttachmentId"
                           v-if="scope.row.Type && imgType.indexOf(scope.row.Type) != -1" style="max-height: 50px; max-width: 100%" v-b-modal="'zoomer' + scope.row.AttachmentId">
                      <b-modal class="text-primary modal-fullscreen" :id="'zoomer' + scope.row.AttachmentId" ref="zoomer" title="Fullsize"  header-bg-variant="primary" hide-footer>
                  ...
                  <el-table
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        ...
                        <img :src="base + 'Download.ashx?Id=' + scope.row.AttachmentId"
                           v-if="scope.row.Type && imgType.indexOf(scope.row.Type) != -1" style="max-height: 50px; max-width: 100%" v-b-modal="'zoomer' + scope.row.AttachmentId">
                        <b-modal class="text-primary modal-fullscreen" :id="'zoomer' + scope.row.AttachmentId" ref="zoomer" title="Fullsize"  header-bg-variant="primary" hide-footer hide-header>
                          <div class="img-border text-center">
                            <img :src="base + 'Download.ashx?Id=' + scope.row.AttachmentId"
                             v-if="scope.row.Type && imgType.indexOf(scope.row.Type) != -1">
                          </div>
