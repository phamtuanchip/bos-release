<template>
<div><b-modal class="chartFilter text-primary" id="CountFilter" ref="CountFilter" title="Bộ lọc"  header-bg-variant="primary" hide-footer>
                <template>
                  <ProjectFilter :onChangeWorker="onChangeWorker"
                      ...
                      :workers="users"
                      :status="listStatus" ></ProjectFilter>
                </template>
               </b-modal>
<div class="table-responsive project-count">
  <div class="ProjectCountInlineFilter mt-2 float-right" v-if="!$isMobileDevice">
                <ProjectFilter :onChangeWorker="onChangeWorker"
                      :onChangeDate="onChangeDate"
                      :onChangeStatus="onChangeStatus"
                      :onChangeActive="onChangeActive"
  ...
  methods: {
    ...
    initTable() {
      ...
      if (this.selectedActive) {
        console.log(this.selectedActive, this.active);
