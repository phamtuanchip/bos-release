    ...
    <el-table :data="this.datasource"
      ...
      <el-table-column prop="FileName"
        ...
        <template slot-scope="scope">
          <a v-if="!$isMobileDevice" :href="base + 'Download.ashx?Id=' + scope.row.Id" target="_blank">{{scope.row.FileName}}</a>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        base: window.location.hostname === 'localhost' ? this.$Utils.URL() + '/' : '/',
        CountFile: 0,
      };
    },
    created() {
