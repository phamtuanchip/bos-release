...
<script>
  ...
  export default {
    ...
    data() {
      ...
      dat.permissionModel.LeadershipDynamicProject = '';
      dat.permissionModel.LeadershipDynamicCase = '';
      dat.permissionModel.LeadershipDynamicValue = '';
    ...
    methods: {
      ...
      bindListPermissions() {
        ...
        if (ctrl.fullData.permissionModel.listScriptPermissions.length > 0) {
          ...
          node.LeadershipDynamicProject = ctrl.fullData.permissionModel.LeadershipDynamicProject;
          node.LeadershipDynamicCase = ctrl.fullData.permissionModel.LeadershipDynamicCase;
          node.LeadershipDynamicValue = ctrl.fullData.permissionModel.LeadershipDynamicValue;
    ...
    created(){
      this.fullData.loading = this.$loading({
        lock: true,
        text: 'Loading',
